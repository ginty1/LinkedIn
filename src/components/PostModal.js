...
function PostModal(props) {
  ...
  const handleChange = (e) => {
    ...
    if (image === "" || image === undefined) {
      alert("not an img, the file is a ${typeof image}");
      return;
    }
    setShareImage(image);
  };
            ...
            <SharedCreation>
              <AttachAssets>
                <AssetsButton onClick={() => switchAssetArea("image")}>
                  <img src="/img/share-photo.svg" alt="" />
                </AssetsButton>
                <AssetsButton onClick={() => switchAssetArea("media")}>
                  <img src="/img/share-video.svg" alt="" />
                </AssetsButton>
              </AttachAssets>
              <ShareComment>
                <AssetsButton>
                  <img src="/img/share-comment.svg" alt="" />
                  anyone
                </AssetsButton>
              </ShareComment>
              <PostButton
